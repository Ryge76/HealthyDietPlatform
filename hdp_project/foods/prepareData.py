...
class Parser:
    ...
    def __init__(self, api_data, auto=True):
        # getting list of criteria
        self.criteria = api_data.param['fields'].split(',')

        # getting list of product
        self.products_list = api_data.json['products']
        self.category = api_data.json['categ_name']
        self.final_result = []
